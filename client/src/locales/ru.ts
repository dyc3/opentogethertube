export default {
	"landing": {
		...
		intro: {
			...
			text3: "На данный момент Вы можете смотреть онлайн видео с своими друзьями с Youtube, Vimeo, Dailymotion. Прямых ссылок на видео в формате .mp4 и в ближайшее время их будет",
			link: "ещё больше.",
		},
		features: {
	...
	"faq": {
		...
		questions: [
			...
			{
				question: "Я хочу создать вечную комнату с изменяемым URL.",
			...
			},
			{
				...
				answer: "YouTube-поиск дорого содержать. Из-за этого мы сократили количество поисков. Если это происходит, просто найдите видео на YouTube и скопируйте ссылку.",
			},
			{
				question: "Как работают вечные комнаты?",
				answer: 'На данный момент, вечные комнаты лишь создают изменяемые URL-адреса, и кто угодно может к вам подключиться. Если Вы вошли в аккаунт, вы можете стать владельцем вечной комнаты, если у неё ещё нет владельца. Комнату можно сделать приватной, и только приглашённые пользователи могут попасть в неё. Это потребует наличие аккаунта у всех приглашённых, но это предотвратит случайное попадание в вашу комнату неавторизованных пользователей. Узнать прогресс разработки приватных комнат можно здесь: <a href="https://github.com/dyc3/opentogethertube/issues/261">dyc3/opentogethertube#261</a>',
			},
		],
	},
	"nav": {
	...
	"privacy": {
		...
		text5: {
			"text": "OpenTogetherTube использует GDPR. Если по какой-то причине вам нужна строчка, содержащая данные о Вашем аккаунте, свяжитесь со мной в",
			"link-text": "Twitter.",
		},
		text6: {
