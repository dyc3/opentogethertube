export default {
	"landing": {
		...
		intro: {
			...
			text1: " - платформа для синхронного просмотра видео в реальном времени.\nОна легка в использовании и не требует регистрации. Просто создайте комнату, добавьте видео и\nпригласите Ваших друзей. БУМ! Вы готовы смотреть видео со своими друзьями до 3 часов ночи.",
			...
			text3: "На данный момент Вы можете смотреть онлайн видео со своими друзьями с Youtube, Vimeo, Dailymotion, прямых ссылок на видео в формате .mp4 и в ближайшее время их будет",
			link: "ещё больше.",
		},
		features: {
			...
			"permanent-rooms": {
				...
				text: "Ваша компанией друзей часто возвращается сюда? Избегите хлопот\nс отправкой новой ссылки каждый раз.. Постоянные\nкомнаты получают персональный кастомизируемый URL-адрес.",
			},
			"dark-theme": {
				title: "Тёмная тема",
