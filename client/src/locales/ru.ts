...
export default {
	...
	"landing": {
		hero: {
			...
			description:
				"Синхронный просмотр в реальном времени. Система голосования.\nТёмная тема. Без регистрации. Открытый исходный код.\nСмотреть видео вместе стало проще простого!",
			btns: {
	...
	"my-rooms": {
		"confirm-delete": 'Навсегда удалить комнату "{name}"? Это действие нельзя отменить.',
	},
	"room-list": {
	...
	"video": {
		...
		"no-video-text": 'Нажмите "Добавить" ниже, чтобы добавить видео.',
	},
	"add-preview": {
	...
	"client-settings": {
		...
		"enable-adapter-selector": "Показывать селектор адаптера (для опытных)",
	},
	"connect-overlay": {
		"title": "Отключено",
	...
	"player": {
		...
		"playback-error-title": {
			unknown: "Ошибка воспроизведения",
		},
